...
const faqItems: FaqItem[] = [
  {
    ...
    body: (
      <p className={P_CLASS}>
        ...
        globally. The organization focuses on Community, Family, Youth, Church,
        and Council programs. Members donated more than $185 million to
        charities and volunteered more than 75 million hours in a single recent
        year. Core principles include charity, unity, fraternity, and
        patriotism.
      </p>
    ),
  },
  {
    ...
    body: (
      <p className={P_CLASS}>
        ...
        Your application is approved at a monthly business meeting, after which
        you attend a degree exemplification ceremony to complete membership.
        Contact{' '}
  ...
  },
  {
    ...
    body: (
      <p className={P_CLASS}>
        As of 2020, the first three degrees are combined into one ceremony — the{' '}
        <em>Exemplification of Charity, Unity and Fraternity</em> — open to the
        whole family. The Fourth Degree focuses on patriotism and is required
    ...
    body: (
      <ul className={UL_CLASS}>
        <li className={LI_CLASS}>
          <strong className={STRONG_CLASS}>Local Council:</strong> Grand Knight
          Steve Shields
        </li>
        <li className={LI_CLASS}>
          <strong className={STRONG_CLASS}>District:</strong> District Deputy
          Jay Hallam (District 18)
        </li>
        <li className={LI_CLASS}>
          <strong className={STRONG_CLASS}>State:</strong> State Deputy Brian
          Ripple (Virginia)
        </li>
        <li className={LI_CLASS}>
  ...
  },
  {
    ...
    body: (
      <p className={P_CLASS}>
        The Third Degree emblem features a knight’s shield mounted on a formée
        Cross. The Fourth Degree emblem displays the Dove, the Cross, and the
        Globe.
      </p>
    ),
  },
  {
    ...
    body: (
      <p className={P_CLASS}>
        Founded in 1882 by Blessed Michael J. McGivney at St. Mary’s Church in
        New Haven, Connecticut, where Supreme headquarters remains today. Father
        McGivney was beatified on October 31, 2020.
      </p>
    ),
  },
  {
  ...
  },
  {
    ...
    body: (
      <p className={P_CLASS}>
        Annual dues are $58, supporting council communication and administration
        costs. The council can waive dues for any brother or potential brother
        in financial need.
      </p>
    ),
  },
  {
    ...
    body: (
      <p className={P_CLASS}>
        Approximately one-third of Knights purchase life insurance, annuities,
        or long-term care coverage through the organization. The Knights of
        Columbus maintains the highest ratings from A.M. Best (A++ Superior) and
        Standard & Poor’s (AAA Extremely Strong). Additional benefits include
        scholarships and orphan benefits.
      </p>
    ),
  },
  {
    ...
    body: (
      <p className={P_CLASS}>
        ...
        emphasizes being involved in your community while supporting your local
        Catholic Church.
      </p>
    ),
  },
  ...
  },
  {
    ...
    body: (
      <p className={P_CLASS}>
        The Knights champion pro-life causes from conception to natural death.
        Signature programs include participation in the March for Life, support
        for pregnancy centers, ultrasound initiatives, and Christian refugee
        relief efforts.
      </p>
    ),
  },
  ...
  },
  {
    ...
    answerText: 'Watch the Bishop’s perspective: https://youtu.be/CdbpuSWP51M',
    body: (
      <p className={P_CLASS}>
